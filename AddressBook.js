...
try {
    contactDetailsArray.push(new AddressBook("Ankit", "Singh", "Park Street", "Lucknow", "UttarPradesh", "226001","91 9450172185", "ankit@gmail.com"));
    contactDetailsArray.push(new AddressBook("Karan", "Singh", "Park Avenue", "Pune", "Karnataka","200200", "91 9696992265", "karan@gmail.com"));  
    contactDetailsArray.push(new AddressBook("Gunjan", "Sharma", "Mall Steet", "Bangalore", "Maharashtra", "400400", "91 9450158963", "gunjan@gmail.com"));
    contactDetailsArray.push(new AddressBook("Rajesh", "Sinha", "Wall Street", "Wapi", "Maharashtra","600600", "91 9696335596", "rajesh@gmail.com"));    
}
catch(e)
{
    console.error(e);
...
let personContact = new AddressBook('Anurag', 'Singh', 'Delhi', 'Delhi', 'Delhi', '500500', '91 8452115786', 'anudelhi@gmail.com');
